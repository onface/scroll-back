...
/******/ 	__webpack_require__.p = "/scroll/0.1.0";
/******/
    ...
    _createClass(Basic, [{
        ...
        value: function componentDidMount() {
            ...
            self.scroll = new Scroll({
                onRelease: function onRelease(overflow) {
                ...
                overflow: function overflow(mount) {
                    return {
                        start: {
                        ...
                        throttle: function throttle(distance) {
                            var min = 0.5;
                            var retard = 1 - (Math.abs(distance / self.refsScroll.offsetHeight) + min);
                            return retard;
                        }
                    };
                },
                onChange: function onChange(mount) {
                    self.setState({
                ...
                __webpack_require__("./node_modules/react/index.js").createElement(
                    ...
                    __webpack_require__("./node_modules/react/index.js").createElement(
                        ...
                        __webpack_require__("./node_modules/react/index.js").createElement(
                            ...
                            __webpack_require__("./node_modules/react/index.js").createElement('div', { style: { height: '20em' } }),
                            __webpack_require__("./node_modules/react/index.js").createElement(
                                'h3',
                                null,
                                'h3'
...
var _motionLogic = __webpack_require__("./node_modules/motion-logic/lib/index.js");
...
Scroll.prototype.emitChange = function (mount, mode) {
    ...
    var overflow = self.settings.overflow(mount);
...
Scroll.prototype.touchEnd = function (value) {
    ...
    var overflow = self.settings.overflow(0);
    ...
    if (Math.abs(beforeEndTime.mount) > 30) {
        self.motion = new _motionLogic2.default({
            effect: 'easeOutQuart',
