...
/******/ 	__webpack_require__.p = "/scroll/0.2.0";
/******/
...
var Scroll = __webpack_require__("./lib/index.js");
    ...
    _createClass(Basic, [{
        ...
        value: function componentDidMount() {
            ...
            self.scroll = new Scroll({
                onRelease: function onRelease(padding) {
                    return true;
                },
                padding: function padding(mount) {
                    return {
                ...
                throttle: function throttle(padding) {
                ...
                onChange: function onChange(mount, padding) {
        ...
        value: function render() {
            ...
            return __webpack_require__("./node_modules/react/index.js").createElement(
                ...
                __webpack_require__("./node_modules/react/index.js").createElement(
                    'pre',
                    null,
                    JSON.stringify(self.state.padding, null, 4)
                ),
                __webpack_require__("./node_modules/react/index.js").createElement(
                    'div',
                    { className: 'scroll', ref: function ref(node) {
                            self.$refs = self.$refs || {};self.$refs.scroll = node;
                        },
                    ...
                    __webpack_require__("./node_modules/react/index.js").createElement(
                        'div',
                        {
                            ...
                            ref: function ref(node) {
                                self.$refs = self.$refs || {};self.$refs.content = node;
                            },
                            style: {
                        ...
                        __webpack_require__("./node_modules/react/index.js").createElement(
                            ...
                            __webpack_require__("./node_modules/react/index.js").createElement('img', { src: 'https://picsum.photos/100/2000', alt: '' }),
                            __webpack_require__("./node_modules/react/index.js").createElement(
                                'h3',
                                null,
                                'end'
...
function getBeforeEndTime(data) {
    ...
    data = _safeExtend2.default.clone(data);
    data.reverse();
    ...
    var mount = output[0].value - output[output.length - 1].value;
    return {
        mount: mount,
...
var _faceMotion = __webpack_require__("./node_modules/face-motion/lib/index.js");

var _faceMotion2 = _interopRequireDefault(_faceMotion);

var _getBeforeEndTime = __webpack_require__("./lib/getBeforeEndTime.js");

var _getBeforeEndTime2 = _interopRequireDefault(_getBeforeEndTime);
...
var Scroll = function Scroll(props) {
    ...
    var self = this;
    self.settings = _safeExtend2.default.clone(props);
    self.data = {
        start: null,
        relativeMove: []
    };
...
Scroll.prototype.getPadding = function (mount) {
    var self = this;
    var padding = self.settings.padding(mount);
...
Scroll.prototype.emitChange = function (mount, mode) {
    var self = this;
    var padding = self.getPadding(mount);
    if (mode === 'none') {
...
Scroll.prototype.touchMove = function (value) {
    var self = this;
    var mountValue = self.addData(value);
    self.emitChange(-mountValue);
};
Scroll.prototype.addData = function (value) {
    var self = this;
    var lastMove = self.data.relativeMove[self.data.relativeMove.length - 1];
    value = value || lastMove.value + self.data.start;
    var moveMount = value - self.data.start;
    self.data.relativeMove.push({
        value: moveMount,
        time: new Date().getTime()
    });
    var mountValue = lastMove.value - moveMount;
    return mountValue;
};
Scroll.prototype.touchEnd = function (value) {
    var self = this;
    self.addData();
    var beforeEndTime = (0, _getBeforeEndTime2.default)(self.data.relativeMove);
    var padding = self.getPadding(0);
    ...
    if (Math.abs(beforeEndTime.mount) > 20 && !padding.overflow) {
        self.motion = new _faceMotion2.default({
            duration: 2000,
            startSpeed: beforeEndTime.speed,
            endSpeed: 0,
            onAction: function onAction(mount, speed) {
...
Scroll.prototype.close = function () {
    var closePadding = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
...
/***/ "./node_modules/face-motion/lib/animate.js":
/***/ (function(module, exports, __webpack_require__) {
...
var _index = __webpack_require__("./node_modules/face-motion/lib/index.js");
...
var _getDefaultSettings = __webpack_require__("./node_modules/face-motion/lib/getDefaultSettings.js");

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function aniamte(settings) {
    settings = (0, _extend2.default)(true, (0, _getDefaultSettings.getAnimateSettings)(), settings);
...
/***/ "./node_modules/face-motion/lib/easing.js":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./node_modules/face-motion/lib/getDefaultSettings.js":
/***/ (function(module, exports, __webpack_require__) {
...
exports.getAnimateSettings = getAnimateSettings;

/***/ }),

/***/ "./node_modules/face-motion/lib/index.js":
/***/ (function(module, exports, __webpack_require__) {
...
var _easing = __webpack_require__("./node_modules/face-motion/lib/easing.js");

var _easing2 = _interopRequireDefault(_easing);

var _animate = __webpack_require__("./node_modules/face-motion/lib/animate.js");

var _animate2 = _interopRequireDefault(_animate);

var _mount = __webpack_require__("./node_modules/face-motion/lib/mount.js");
...
var Motion = (_temp = _class = function Motion(settings) {
...
Motion.prototype.emitChange = function (mount, speed) {
    var self = this;
    if (self.settings.value < 0) {
        mount = -mount;
    }
    self.settings.onAction(mount, speed);
};
Motion.prototype.run = function () {
    ...
    requestAnimationFrame(function action() {
        ...
        if (self.isAccAnimate) {
            ...
            actionSpeed = settings.startSpeed + averageAcc;
            mount = elapsedTime * actionSpeed;
        } else {
            var currentMount = self.effect.apply(_easing2.default, [actionTime, 0, value, animateDuration]);
        ...
        self.emitChange(mount, actionSpeed);
        // 千万不要直接附值 lastActionTime = new Date().getTime()
        // 因为上面代码运行需要时间
        self.lastActionTime = nowTime;
        if (actionTime === animateDuration) {
            self.emitChange(0, settings.endSpeed);
            settings.onDone();
        } else {
            if (self.isRuning) {
...
/***/ "./node_modules/face-motion/lib/mount.js":
/***/ (function(module, exports, __webpack_require__) {
...
*/
var ba=__webpack_require__("./node_modules/fbjs/lib/invariant.js"),ea=__webpack_require__("./node_modules/react/index.js"),m=__webpack_require__("./node_modules/fbjs/lib/ExecutionEnvironment.js"),A=__webpack_require__("./node_modules/object-assign/index.js"),C=__webpack_require__("./node_modules/fbjs/lib/emptyFunction.js"),fa=__webpack_require__("./node_modules/fbjs/lib/getActiveElement.js"),ha=__webpack_require__("./node_modules/fbjs/lib/shallowEqual.js"),ja=__webpack_require__("./node_modules/fbjs/lib/containsNode.js"),ka=__webpack_require__("./node_modules/fbjs/lib/emptyObject.js");
